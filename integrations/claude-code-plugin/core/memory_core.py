...
def api_base_url() -> str:
    """Resolve the API endpoint, retaining the downstream CLI-compatible alias."""
    return (os.environ.get("MEM0_API_URL") or os.environ.get("MEM0_BASE_URL") or DEFAULT_API_URL).rstrip("/")
...
def search_memories(
    ...
    *,
    ...
    url = api_base_url() + "/v3/memories/search/"
    started = time.perf_counter()
    try:
